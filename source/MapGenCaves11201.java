...
//            MapGenBase11201, MathHelper, Block, BlockGrass, 
//            World

public class MapGenCaves11201 extends MapGenBase11201
{

    public MapGenCaves11201()
    {
    }
            ...
            double d3)
    {
        ...
        for(; k < l; k++)
        {
            ...
            for(int j2 = (int)d8; !flag2 && j2 < k1; j2++)
            {
                ...
                {
                    for(int i3 = l1 + 1; !flag2 && (double)i3 >= d9 - 1.0D; i3--)
                    {
                        ...
                        if((double)i3 != d9 - 1.0D && (double)j2 != d8 && j2 != k1 - 1 && (double)l2 != d10 && l2 != i2 - 1)
                        {
                            i3 = (int)d9;
                        }
                    }
            ...
            for(int k2 = (int)d8; k2 < k1; k2++)
            {
                ...
                for(int k3 = (int)d10; k3 < i2; k3++)
                {
                    ...
                    boolean flag3 = false;
                    for(int i4 = l1 - 1; (double)i4 >= d9; i4--)
                    {
