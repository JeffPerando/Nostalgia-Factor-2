...
//            NoiseGenerator, NoiseGeneratorPerlin173

public class NoiseGeneratorOctaves173 extends NoiseGenerator
{

    private NoiseGeneratorPerlin173 generatorCollection[];
    private int octaves;

    public NoiseGeneratorOctaves173(Random random, int i)
    {
        octaves = i;
        generatorCollection = new NoiseGeneratorPerlin173[i];
        for(int j = 0; j < i; j++)
        {
            generatorCollection[j] = new NoiseGeneratorPerlin173(random);
        }
