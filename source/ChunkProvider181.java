...
public class ChunkProvider181 implements IChunkProvider
{
    ...
    private int generatorType2;

    public ChunkProvider181(World world, long l, boolean flag, int i)
    {
        generatorType2 = 0;
    ...
    public void generateTerrain(int i, int j, byte abyte0[])
    {
        ...
        int k1 = byte0 + 1;
        biomesForGeneration = worldObj.getWorldChunkManager().func_35557_b(biomesForGeneration, i * 4 - 2, j * 4 - 2, i1 + 5, k1 + 5, 1);
