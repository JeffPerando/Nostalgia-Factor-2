...
//            NoiseGenerator, NoiseGenerator09

public class NoiseGeneratorOctaves09 extends NoiseGenerator
{

    private NoiseGenerator09 field_4234_a[];
    private int field_4233_b;

    public NoiseGeneratorOctaves09(Random random, int i)
    {
        field_4233_b = i;
        field_4234_a = new NoiseGenerator09[i];
        for(int j = 0; j < i; j++)
        {
            field_4234_a[j] = new NoiseGenerator09(random);
        }
