...
//            World, ChunkProvider11201

public class MapGenBase11201
{

    protected int range;
    protected Random rand;

    public MapGenBase11201()
    {
        range = 8;
        rand = new Random();
    }

    public void generate(ChunkProvider11201 chunkprovider11201, World world, int i, int j, byte abyte0[])
    {
        int k = range;
